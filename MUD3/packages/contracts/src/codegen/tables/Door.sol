...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Door")));
bytes32 constant DoorTableId = _tableId;
...
library Door {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "nextCoord";
    return ("Door", _fieldNames);
  }
  ...
  function encode(uint256 nextCoord) internal view returns (bytes memory) {
    return abi.encodePacked(nextCoord);
  }

...
library Player {
  ...
  /** Get level */
  function getLevel(bytes32 key) internal view returns (uint8 level) {
  ...
  function getLevel(IStore _store, bytes32 key) internal view returns (uint8 level) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set level */
  function setLevel(bytes32 key, uint8 level) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setLevel(IStore _store, bytes32 key, uint8 level) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, uint8 level, string memory name) internal {
    bytes memory _data = encode(level, name);
  ...
  function set(IStore _store, bytes32 key, uint8 level, string memory name) internal {
    bytes memory _data = encode(level, name);
  ...
  function set(IStore _store, bytes32 key, PlayerData memory _table) internal {
    set(_store, key, _table.level, _table.name);
  }
  ...
  function decode(bytes memory _blob) internal view returns (PlayerData memory _table) {
    ...
    _table.level = (uint8(Bytes.slice1(_blob, 0)));
  ...
  function encode(uint8 level, string memory name) internal view returns (bytes memory) {
    uint40[] memory _counters = new uint40[](1);
    _counters[0] = uint40(bytes(name).length);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(level, _encodedLengths.unwrap(), bytes((name)));
  }

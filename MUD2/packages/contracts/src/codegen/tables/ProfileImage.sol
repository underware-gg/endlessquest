...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ProfileImage")));
bytes32 constant ProfileImageTableId = _tableId;

library ProfileImage {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "url";
    return ("ProfileImage", _fieldNames);
  }
  ...
  /** Get url */
  function get(bytes32 key) internal view returns (string memory url) {
  ...
  function get(IStore _store, bytes32 key) internal view returns (string memory url) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set url */
  function set(bytes32 key, string memory url) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(IStore _store, bytes32 key, string memory url) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

...
library Metadata {
  ...
  /** Get metadata */
  function get(bytes32 key) internal view returns (string memory metadata) {
  ...
  function get(IStore _store, bytes32 key) internal view returns (string memory metadata) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set metadata */
  function set(bytes32 key, string memory metadata) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(IStore _store, bytes32 key, string memory metadata) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
